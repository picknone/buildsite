...
+----------------------------------------------------------------------
| 安装脚本：curl -sSO https://github.com/picknone/buildsite/raw/main/one_key_happy.sh && bash install_panel.sh
+----------------------------------------------------------------------
"
while [ "$go" != 'y' ] && [ "$go" != 'n' ]
do
...
if [ -f ${plugin_file} ];then
    ...
    wget https://raw.githubusercontent.com/picknone/buildsite/main/one_key_happy/plugin.json
    chattr +i /www/server/panel/data/plugin.json
else
    cd /www/server/panel/data
    wget https://raw.githubusercontent.com/picknone/buildsite/main/one_key_happy/plugin.json
...
if [ -f ${repair_file} ];then
    ...
    cd /www/server/panel/data
    wget https://raw.githubusercontent.com/picknone/buildsite/main/one_key_happy/repair.json
    chattr +i /www/server/panel/data/repair.json
else
    cd /www/server/panel/data
    wget https://raw.githubusercontent.com/picknone/buildsite/main/one_key_happy/repair.json
